...
function enviarEmail($para, $pedidoId, $total)
{
    ...
    try {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = 'seu email@gmail.com'; // Seu e-mail de teste
        $mail->Password = 'inserirsenha'; // Gere uma senha de app se usar 2FA
        $mail->SMTPSecure = 'tls';
        $mail->Port = 587;

        // Remetente e destinatário
        $mail->setFrom('seu email@gmail.com', 'ERP Montink');
